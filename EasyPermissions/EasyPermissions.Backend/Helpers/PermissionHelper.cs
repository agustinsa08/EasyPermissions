...
namespace EasyPermissions.Backend.Helpers
{
    public class PermissionHelper: IPermissionHelper
    {
        ...
        public PermissionHelper(IUsersUnitOfWork usersUnitOfWork, IPermissionsUnitOfWork permissionsUnitOfWork, ICategoryPermissionsUnitOfWork categoryPermissionsUnitOfWork, IUsersRepository usersRepository, IMailHelper mailHelper)
        {
        ...
        public async Task<ActionResponse<bool>> ProcessPermissionAsync(string email, int categoryPermissionId, string description)
        {
            ...
            <div style='font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;'>
                ...
                <p>Nos complace informarle que se ha registrado un nuevo permiso en Permisos Fácil con estado <strong>Pendiente</strong>. A continuación, el detalle:</p>
                ...
                <div style='font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;'>
                    ...
                    <p>Se ha registrado un nuevo permiso en Permisos Fácil con estado <strong>Pendiente</strong>. A continuación, el detalle:</p>
